(function () {
  ...
  function ivMonthlyRender() {
    ...
    if (monthlyRowsEl) {
      ...
      monthlyRowsEl.innerHTML = monthlyRowsLoaded.toLocaleString('en-IN') + ' <span style="font-weight: normal; opacity: 0.8; font-size: 11px;">(' + validCount.toLocaleString('en-IN') + ' analyzed)</span>';
    }
